...
function ProjectCard({ p, i }: { p: (typeof projects)[0]; i: number }) {
  ...
  return (
    <motion.article
      ...
      className="relative min-w-[300px] md:min-w-[420px] h-[340px] snap-center rounded-3xl border border-accent/20 bg-gradient-to-br from-[#020617] to-[#040c1a] p-8 flex flex-col justify-between group transition-all duration-300 hover:border-accent hover:shadow-[0_0_50px_var(--accent-glow)]"
    >
      <div style={{ transform: "translateZ(50px)" }}>
        <div className="flex justify-between items-start mb-6">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-accent hover:bg-accent/10 hover:border-accent hover:shadow-[0_0_20px_var(--accent-glow)] transition-all duration-300"
        ...
        <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-accent transition-colors tracking-tight">
          {p.name}
        </h3>
